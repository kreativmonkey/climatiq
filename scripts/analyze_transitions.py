...
def analyze_transitions(days=30):
    ...
    df_outdoor = client.get_entity_data('ac_temperatur_outdoor', start_time, end_time, resample='1m')
    ...
    for t in transitions:
        ...
        # Temp Delta
        t_out = df_outdoor.loc[window_start:window_end, 'value'].mean() if not df_outdoor.empty else None
