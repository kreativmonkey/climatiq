...
df_ml[df_ml["target"] == 0]["power_std"].hist(
    bins=30, alpha=0.6, color="green", label="Stable", ax=ax4
)
df_ml[df_ml["target"] == 1]["power_std"].hist(
    bins=30, alpha=0.6, color="red", label="Unstable", ax=ax4
)
...
feature_importance_df.to_csv(
    "/home/diyon/.openclaw/workspace/climatiq/data/feature_importance.csv", index=False
)
