...
# Load data
df = pd.read_csv(
    "/home/diyon/.openclaw/workspace/climatiq/data/power_last_5days.csv",
    index_col=0,
    parse_dates=True,
)
...
ax2.axhline(
    50, color="green", linestyle="--", linewidth=1, alpha=0.5, label="Stable threshold (50W)"
)
...
ax4.fill_between(
    ...
    0,
    100,
    where=df["cycling_risk"] > 70,
    alpha=0.2,
    color="red",
    label="Cycling detected",
)
...
plt.tight_layout()
plt.savefig(
    "/home/diyon/.openclaw/workspace/climatiq/data/cycling_analysis.png",
    dpi=150,
    bbox_inches="tight",
)
...
ax3.fill_between(
    df_recent.index, 0, 100, where=df_recent["cycling_risk"] > 70, alpha=0.3, color="red"
)
...
plt.tight_layout()
plt.savefig(
    "/home/diyon/.openclaw/workspace/climatiq/data/cycling_analysis_24h.png",
    dpi=150,
    bbox_inches="tight",
)
